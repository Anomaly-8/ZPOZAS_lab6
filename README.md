...
13. **Сравните этап "Разведка" в Kill Chain и тактику "Сбор информации" в модели MITRE ATT&CK.** **Общее:** Цель — сбор данных о цели. **Различие:** В Kill Chain это один из семи линейных этапов. В ATT&CK — это одна из многих тактик, которая может применяться многократно и нелинейно на протяжении всей атаки.
14. **Как концепция "Обороны в глубину" (Defense in Depth) связана с моделью Kill Chain?** "Оборона в глубину" реализуется путем выстраивания контрмер для *каждого этапа* Kill Chain, создавая многоуровневую защиту, где прорыв одного рубежа не означает прорыва всей обороны.
